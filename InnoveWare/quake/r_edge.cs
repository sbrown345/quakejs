...
namespace quake
{
    public partial class render
    {
        ...
        */
        ...
        static edge_t[]     auxedges;
        static edge_t[]	    r_edges;
        static int          edge_p, edge_max;

        public static surf_t[] surfaces;
        public static int      surface_p, surf_max;

        // surfaces are generated in back to front order by the bsp, so if a surf
        // pointer is greater than another one, it should be drawn in front
        // surfaces[1] is the background, and is used as the active surface stack

        static edge_t[]	    newedges = new edge_t[MAXHEIGHT];
        static edge_t[]     removeedges = new edge_t[MAXHEIGHT];

        static espan_t[]    basespans;
        static int          span_p, max_span_p;
        ...
        static drawfunc     pdrawfunc;

        static edge_t	    edge_head = new edge_t();
        static edge_t       edge_tail = new edge_t();
        static edge_t       edge_aftertail = new edge_t();
        static edge_t       edge_sentinel = new edge_t();
        ...
        */
        ...
        // clear active surfaces to just the background surface
	        surfaces[0].next = surfaces[0].prev = surfaces[0];
	        surfaces[0].last_u = edge_head_u_shift20;
        ...
        ==============
        */
        static void R_GenerateSpansBackward ()
        {
        }
